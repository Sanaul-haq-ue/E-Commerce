            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Unite Module</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Icons</a></li>
                        <li><a href="{{ route('unite.index') }}" class="slide-item">Manage Unite</a></li>
                        <li><a href="{{ route('unite.create') }}" class="slide-item">Add Unite</a></li>
