                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" value="{{ old('name') }}" name="name" id="productName" placeholder="Enter your Product name" type="text" required="required">
                                    @if($errors->has('name'))
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" value="{{ old('code') }}" name="code" id="productCode" placeholder="Enter your Product code" type="text" required="required">
                                    @if($errors->has('code'))
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="short_description" id="short_description" cols="30" rows="4" placeholder="Enter your Short Description"></textarea>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="long_description" class="col-md-3 form-label">Long Description</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" name="long_description" id="summernote" cols="30" rows="4" placeholder="Enter your Long Description"></textarea>
                                </div>
                            </div>
{{--                            <div class="row mb-4">--}}
                                ...
                                <div class="col-md-9">
                                    <div class="row input-group">
                                        <div class="w-50 price">
                                            <input class="form-control" name="regular_price" placeholder="Enter your Regular price" type="number">
                                        </div>
                                        <div class="w-50">
                                            <input class="form-control" name="selling_price" placeholder="Enter your Selling price" type="number">
                                        </div>
                                    </div>
{{--                                    @if($errors->has('name'))--}}
{{--                                        <div class="alert alert-danger mt-1">{{ $errors->first('name') }}</div>--}}
{{--                                    @endif--}}
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" name="stock_amount" id="stockAmout" placeholder="Stock Amout" type="number">
