                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('size.update',$size->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{ $size->name }}" name="name" id="firstName" placeholder="Enter your Size name" type="text" required="required">
                                @if($errors->has('name'))
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{ $size->code }}" name="code" id="code" placeholder="Enter your Code name" type="text" required="required">
                                @if($errors->has('code'))
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="description" cols="30" rows="4" placeholder="Enter your Size Description">{{ $size->description }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <label for="email" class="col-md-3 form-label">Publication Status</label>
                            <div class="col-md-9 mt-2 p">
                                <label ><input type="radio" value="1" {{ $size->status == 1 ? 'checked' : '' }} checked name="status"><span>Published</span></label>
