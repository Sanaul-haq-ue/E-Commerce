    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create Unite</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col-lg-10 offset-lg-1 col-md-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Add Unite Form</h3>
                </div>
                <div class="card-body">
                    @if( session('message') )
                        <p class="alert alert-success">{{ session('message') }}</p>
                    @endif
                    <form class="form-horizontal" action="{{ route('unite.store') }}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="row mb-4">
                            <label for="firstName" class="col-md-3 form-label">Unite name</label>
                            <div class="col-md-9">
                                <input class="form-control" name="name" value="{{ old('name') }}" id="firstName" placeholder="Enter your Unite name" type="text" required="required">
                                @if($errors->has('name'))
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="description" cols="30" rows="4" placeholder="Enter your Unite Description"></textarea>
                            </div>
                        </div>
                        <div class="row">
