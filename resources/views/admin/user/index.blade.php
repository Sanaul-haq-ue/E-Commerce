        ...
        <div class="col-lg-10 offset-lg-1 col-md-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Manage User Form</h3>
                </div>
                <div class="card-body">
                    @if( session('success') )
                        ...
                        <table id="example3" class="table table-bordered text-nowrap border-bottom">
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td></td>
                                    <td class="d-flex">
                                        <a href="" class="btn btn-info btn-sm me-1" title="View Order Detail">
                                            <i class=" fa fa-eye"></i>
                                        </a>
                                        <a href="" class="btn btn-info btn-sm me-1" title="Order Edit">
