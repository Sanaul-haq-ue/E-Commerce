                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        @foreach ($product->productGallaries as $productGallarie)
                                        
                                        <figure class="border-radius-10">
                                            <img src="{{ asset($productGallarie->product_Gallary) }}" alt="product image">
                                        </figure>
                                    ...
                                    <div class="slider-nav-thumbnails pl-15 pr-15">
                                        @foreach ($product->productGallaries as $productGallarie)
                                        <div><img src="{{ asset($productGallarie->product_Gallary) }}" alt="product image"></div>
                                        @endforeach
                                    </div>
                                </div>
                                <!-- End Gallery -->
                                ...
                                <form action="{{ route('cart.store') }}" method="post">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            <div class="row">
                                                <input type="number" name="qty" class="from-control w-50" value="1" min="1"/>
                                            </div>
